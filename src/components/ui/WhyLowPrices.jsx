      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Des bijoux de qualité premium de <span className="font-bold text-amber-700">2$ à 30$</span> maximum.
          ...
          {reasons.map((reason, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-500 text-white rounded-lg flex items-center justify-center">
                  {reason.icon}
                </div>
                <div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-2xl p-8 md:p-12 text-center text-white shadow-2xl"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/catalogue"
              className="inline-block px-8 py-4 bg-white text-amber-900 font-bold rounded-lg hover:bg-amber-50 transition-all transform hover:scale-105 shadow-lg"
            >
              Découvrir Nos Bijoux
            </a>
            <a
              href="/contact"
              className="inline-block px-8 py-4 bg-transparent border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:text-amber-900 transition-all"
            >
              Nous Contacter
            </a>
          </div>
