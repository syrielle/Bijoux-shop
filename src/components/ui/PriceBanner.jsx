...
const PriceBanner = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-amber-600 via-orange-600 to-amber-600 py-12">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <Link
              to="/catalogue"
              className="inline-block px-8 py-4 bg-white text-amber-900 font-bold text-lg rounded-lg hover:bg-amber-50 transition-all transform hover:scale-105 shadow-2xl"
            >
              Voir Nos Bijoux
            </Link>
          </motion.div>
        ...
        >
          <div className="text-center">
            ...
            <div className="text-sm text-amber-100">Prix Minimum</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-white mb-1">30$</div>
            <div className="text-sm text-amber-100">Prix Maximum</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-white mb-1">100%</div>
            <div className="text-sm text-amber-100">Qualité Garantie</div>
          </div>
        </motion.div>
      </div>
    </section>
